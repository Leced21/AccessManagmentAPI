...
namespace AccessManagmentAPI.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public ProductController(IWebHostEnvironment environment, ContetxtDb contextDb)
        {
        ...
        public async Task<IActionResult> DBMultiUploadImage(IFormFileCollection filecollection, string productcode)
        {
            ...
            try
            {
                foreach (var file in filecollection)
                {
                    ...
                    {
                        await file.CopyToAsync(stream);
                        this._contextDb.TblProductimages.Add(new Repos.Models.TblProductimage()
                        {
        ...
        public async Task<IActionResult> GetDBMultiImage(string productcode)
        {
            ...
            try
            {
                var _productimage = this._contextDb.TblProductimages.Where(item => item.Productcode == productcode).ToList();
        ...
        public async Task<IActionResult> dbdownload(string productcode)
        {
            ...
            try
            {
                ...
                var _productimage = await this._contextDb.TblProductimages.FirstOrDefaultAsync(item => item.Productcode == productcode);
